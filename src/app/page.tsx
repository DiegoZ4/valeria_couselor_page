...
import { User, Clock, Award, Menu, X, Heart, Lightbulb, Users, UserCheck, Search, HelpCircle, HandHeart, Euro, CreditCard, Monitor, ChevronLeft, ChevronRight } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex items-center">
              <h1 className="text-2xl font-bold font-heading text-indigo-600">Valeria Mariana Russo</h1>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <Link href="/" className="text-indigo-600 font-semibold px-3 py-2">
                Inicio
              </Link>
